...
type ServiceItem = {
  key: ServiceKey
  // IMPORTANT: router path (not raw href)
  to: string
    ...
    <main className="pt-32 pb-20">
      ...
      <section ref={ctaRef} id="services-cta" aria-labelledby="services-cta-heading" className="mt-20 md:mt-24">
        <div className="container mx-auto px-6">
          ...
          >
            <h2 id="services-cta-heading" className="text-2xl md:text-3xl font-display font-semibold mb-6">
                ...
                >
                  ...
                  <div className="px-5 pb-6 md:px-7">
                    ...
                    >
                      ...
                      <p
                        className={cn(
                          "relative z-10 text-sm md:text-base text-muted-foreground/95 leading-relaxed",
                          isRTL && "text-right"
                        )}
                      >
                        {item.a}
